        ...
        <div className="share">
            <div className="shareWrapper">
                <div className="shareTop">
                    ...
                    <input placeholder="You wanna say somethin', huh? Go on, do it!" 
                    type="text" className="shareInput" ref={desc} />
                </div>
                ...
                <form className="shareBottom" onSubmit={submitHandler}>
                    <div className="shareOptions">
                        ...
                        <div className="shareOption">
                            <Label htmlColor="pink" className="shareIcon"></Label>
                        ...
                        <div className="shareOption">
                            ...
                            <span className="shareOptionText"> Touchy-Feely </span>
                        </div>
                    </div>
